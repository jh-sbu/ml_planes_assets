...
committed mesh-loading contract. The completed models document provisional orientation,
origin, node names, and material conventions in their asset READMEs; these can be adapted
